    ...
    <form
      ...
      <div className="flex flex-col">
        <textarea
          ...
          rows={1}
          className={`w-full resize-none border-none p-2 focus:outline-none text-base ${
            disabled
              ? isDarkMode
          ...
          <div className="flex items-center gap-2">
            ...
            {showStopButton ? (
              ...
              <button
                ...
                className={`rounded-md bg-[#5A65C2] px-3 py-1 text-white transition-colors hover:enabled:bg-[#0073DC] ${isSendButtonDisabled ? 'cursor-not-allowed opacity-50' : ''}`}>
                {t('chat_buttons_send')}
              </button>
            )}
          </div>
